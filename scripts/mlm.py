...
c4200m_filepath = "./datasets/c4200m.tsv"
...
def partial_dataset_train(texts):
	...
	training_args = TrainingArguments(
	    output_dir=f"{model_checkpoint}-finetuned-c4200m",
...
# In[16]:
model = AutoModelForMaskedLM.from_pretrained("./bert-base-uncased-c4200m-unchaged-vocab")
